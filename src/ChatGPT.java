...
public class ChatGPT {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream input = ChatGPT.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        // Petit prompt d'exemple
        String userPrompt = "Donne moi une idée de projet pour un développeur débutant en Java.";

        try {
            // Envoi la requête à ChatGPT
            String answer = sendChatGPTRequest(userPrompt);
